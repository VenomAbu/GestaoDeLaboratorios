...
namespace GestaoDeLaboratorios.Controllers
{
    public class ComputadoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Processador,PlacaMae,Memoria,HD,Numero,DataDeCompra")] Computador computador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Processador,PlacaMae,Memoria,HD,Numero,DataDeCompra")] Computador computador)
        {
            if (id != computador.Id)
            {
                return NotFound();
